...
//		mn_DSTheHetHan.addActionListener(this);
		...
		JButton btn_Tieude = new JButton("PHIẾU MƯỢN");
		...
		table = new JTable();
		String[] header = {"STT", "Mã phiếu mượn", "Ngày mượn", 
				"Ngày hẹn trả","Tình trạng", "Người mượn (đọc giả)", "Thủ thư" };
		...
		JLabel lblMaDauSach = new JLabel("Mã Đầu Sách:");
		...
		cbxTrangThai.addItem("Chưa trả");
		cbxTrangThai.addItem("Đã trả");
...
//		btn_DSS = new JButton("Danh sách mượn sách");
...
//		
//		btn_DST = new JButton("Danh sách trả sách");
...
//		panel_2.add(btn_DST);
//		
//		btn_DSDK = new JButton("Danh sách đăng kí mượn sách");
